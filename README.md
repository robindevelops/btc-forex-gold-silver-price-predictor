...
![Python](https://img.shields.io/badge/Python-3.9%2B-blue) ![TensorFlow](https://img.shields.io/badge/TensorFlow-2.16-orange) ![LightGBM](https://img.shields.io/badge/LightGBM-4.6-green) ![Streamlit](https://img.shields.io/badge/Streamlit-1.50-red) ![Tests](https://img.shields.io/badge/tests-31%20passing-brightgreen)
...
2. Engineers **stationary, backward-looking features** (returns and 20-day momentum, rolling/HAR/EWMA volatility, RSI/ADX/ROC, normalised MACD, EMA ratios, Bollinger %B/width, ATR/price, macro returns, sentiment) — `docs/FEATURES.md`.
...
The central research question is honest: *does any model beat the random walk at a one-day horizon, and by how much?* Answer (`docs/RESULTS.md`): not for Bitcoin or Gold; yes for Silver on the 2026 test window (62 % direction, DM p = 0.002), with the caveat that its walk-forward figure is 53 %.
...
├── tests/                     31 test cases: look-ahead, target alignment, split, reconstruction, metrics, inference
├── results/                   cv_results.csv · final_test_results.csv · regime_analysis.csv · FINAL_RESULTS.md · tuning/ · figures/ · predictions/ · experiments/ · archive_3y_final/
