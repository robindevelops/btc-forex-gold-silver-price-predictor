...
if __name__ == "__main__":
    ...
    # Use reconstruct_price to properly handle log returns
    # Assuming full_df has columns that reconstruct_price can use to find target_idx if we had it,
    # but here we can just detect it from train_df
